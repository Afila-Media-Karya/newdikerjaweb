<div id="side_form_riwayat_istri" class="bg-white" data-kt-drawer="true" data-kt-drawer-activate="true"
        data-kt-drawer-toggle="#side_form_riwayat_istri_button" data-kt-drawer-close="#side_form_riwayat_istri_close" data-kt-drawer-width="500px">
        <!--begin::Card-->
        <div class="card w-100">
            ...
            <div class="card-header pe-5">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex justify-content-center flex-column me-3">
                        <a href="#"
                            class="fs-4 fw-bolder text-gray-900 title_side_form text-hover-primary me-1 lh-1 title_side_form_riwayat_istri"></a>
                    </div>
                    <!--end::User-->
                </div>
                <!--end::Title-->
                ...
                <div class="card-toolbar">
                    <!--begin::Close-->
                    <div class="btn btn-sm btn-icon btn-active-light-primary" id="side_form_riwayat_istri_close">
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" id="riwayat-istri">
                    ...
                    <div class="row mb-10">
                        ...
                        <input type="text" id="nama_istri" class="form-control"  name="nama_istri" placeholder="Masukkan Nama Istri">
                        <small class="text-danger nama_istri_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" name="memperoleh_tunjangan" type="radio" value="Tidak_Memperoleh" id="Tidak_Memperoleh"/>
                    ...
                    <div class="mb-10">
                     ...
                     <div class="mb-10">
                        <label class="form-label">Foto Buku Nikah</label>
                        <input type="file" id="foto_buku_nikah" class="form-control"  name="foto_buku_nikah">
                        <small class="text-danger foto_buku_nikah_error"></small>
                    </div>                
                    ...
                    <div class="d-flex gap-5">
                        ...
                        <button type="reset" id="side_form_riwayat_istri_close"
