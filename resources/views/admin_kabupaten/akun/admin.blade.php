            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger status_user_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipart('/admins/store', 'Tambah', 'Admin','POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipart('/admins/update/' + uuid, 'Update','Admin', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admins/show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Admin', url);
        })
        ...
        datatable = () =>{
            ...
            control.initDatatable('/admins/datatable', columns, columnDefs);
        }
