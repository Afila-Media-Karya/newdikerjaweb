...
<div class="post d-flex flex-column-fluid" id="kt_post">
                            ...
                            <div class="py-5">
                                ...
                                <div class="row mb-10">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" id="kelompok" class="form-control" name="kelompok"
                                            placeholder="Masukkan nama kelompok" value="{{$data->kelompok}}">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select class="form-select form-control" name="id_jenis_jabatan"
                                            ...
                                            <option value="{{$val->id}}" @if($data->id_jenis_jabatan == $val->id) selected @endif>{{$val->text}} - kelas {{$val->kelas_jabatan}}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div id="repeater-aktivitas">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="javascript:;" data-repeater-create
                                            class="btn btn-icon btn-primary btn-sm" id="tambah-row-repeater">
                                ...
                                <div class="card-footer">
                                    <div class="d-flex gap-5">
                                        ...
                                        <a type="button" href="{{route('kabupaten.master_jabatan.kelompok_aktivitas.index')}}"
    ...
    <script>
        ...
        $(function () {
            ...
            $.ajax({
                url : '/master-jabatan/kelompok-aktivitas/show/{{$data->id}}',
                method : 'GET',
                    ...
                    console.log(res);
                     ...
                     $(".repeater-items").remove();
                        $.each(res.data, function (i, b) {
                            console.log(b);
                        $("#tambah-row-repeater").trigger("click");
                        
                        $(`textarea[name='repeater-aktivitas[${i}][aktivitas]']`).val(b.aktivitas);
                        $(`input[name='repeater-aktivitas[${i}][beban_kerja]']`).val(b.beban_kerja);
                        $(`input[name='repeater-aktivitas[${i}][waktu]']`).val(b.waktu);
                        $(`input[name='repeater-aktivitas[${i}][waktu_penyelesaian]']`).val(b.waktu_penyelesaian);
                        $(`input[name='repeater-aktivitas[${i}][waktu_efektif]']`).val(b.waktu_efektif);
                        $(`select[name='repeater-aktivitas[${i}][satuan]']`)
                                .val(b.satuan)
                                .trigger("change");
