...
@section('script')
    ...
    <script>
        ...
        let pegawai = {!! json_encode($id_pegawai) !!};
        let uuid_pegawai = {!! json_encode($uuid) !!};
           ...
           let label = $(this).attr('data-label');
            ...
            if (result.isConfirmed) {
                ...
                success: function () {
                    ...
                    setTimeout(() => {
                       window.location.href = `/aktivitas-opd/detail-pegawai?pegawai=${uuid_pegawai}`; 
                    }, 1500);
                },
                error: function (xhr) {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            editable: true,
            navLinks: true,
            events: `/aktivitas/getAktivitasForCalenderbyPegawai?pegawai=${pegawai}`,
