            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select class="form-select form-control" id="id_pegawai" name="id_pegawai" data-control="select2" data-placeholder="Pilih Pegawai">
                            <option></option>
                            @foreach($pegawaiAkanPensiun as $value)
...
@section('script')
    <script>
        ...
        let url_main = '';
        role.guard !== 'web' ? url_main = '/pegawai/pegawai-pensiun' : url_main = '/pegawai-opd/pegawai-pensiun-opd';

        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Pegawai Pensiun');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipart(`${url_main}/store`, 'Tambah', 'Pegawai Pensiun','POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipart(`${url_main}/update/` + uuid, 'Update','Pegawai Pensiun', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            ...
            control.overlay_form('Update', 'Pegawai Pensiun', url);
        })
        ...
        $(document).on('change','#id_satuan_kerja', function (e) {
            ...
            if ($(this).val() !== '') {
                control.push_select(`/pegawai/pegawai-akan-pensiun/option/${$(this).val()}`,'#id_pegawai');
            }  
        })
        ...
        datatable = () =>{
            ...
            let columnDefs = [{
                ...
                render: function(data, type, full, meta) {
                    return `
                            <a href="${url_main}/detail/${full.uuid_pegawai}" type="button" data-uuid="${data}" class="btn btn-warning btn-icon btn-sm"> 
