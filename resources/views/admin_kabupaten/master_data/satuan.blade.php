...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Satuan');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipart('/master-data/satuan/store', 'Tambah', 'Satuan','POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipart('/master-data/satuan/update/' + uuid, 'Update','Satuan', 'POST');
            }
        });

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/master-data/satuan/show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Satuan', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/master-data/satuan/delete/' + $(this).attr('data-uuid');
            ...
            let columnDefs = [{
                ...
                render: function(data, type, full, meta) {
                    return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="${full.satuan}" class="btn btn-danger button-delete btn-icon btn-sm"> 
                                <img src="{{ asset('admin/assets/media/icons/trash.svg')}}" alt="" srcset="">
                            </a>
                            `;
                    },
            }];
            control.initDatatable('/master-data/satuan/datatable', columns, columnDefs);
        }
