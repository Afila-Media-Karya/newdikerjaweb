                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="container">
                            <div class="py-5">
                                ...
                                <div class="row mb-10">
                                    <div class="col-lg-6">
                                        <label class="form-label">Jabatan Definitif</label>
                                        <input type="text" class="form-control form-control-sm" value="{{$data->jabatan_definitif}}" disabled>
                                        <small class="text-danger asal_daerah_error"></small>
                                    </div>
                                    <div class="col-lg-6">
                                        <label class="form-label">Jabatan PLT</label>
                                        <input type="text" class="form-control form-control-sm" value="{{$data->jabatan_plt}}" disabled>
                                        <small class="text-danger asal_daerah_error"></small>
                                    </div>
                                </div>
