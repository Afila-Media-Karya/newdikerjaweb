...
<body id="kt_body"
 ...
 @if(ManageFileDatatable($path))
        <script src="{{ asset('admin/assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    @else
        <script src="{{ asset('admin/assets/plugins/custom/datatables/datatables.bundle_old.js') }}"></script>
    @endif
    ...
    <script>
        @if(session('success'))
                Swal.fire({
                    ...
                    icon: 'success',
                    timer: 2500, // Durasi SweetAlert ditampilkan (opsional)
                    showConfirmButton: false // Menyembunyikan tombol OK (opsional)
                });
        @endif
