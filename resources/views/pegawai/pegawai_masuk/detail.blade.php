                            ...
                            <div class="py-5">
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm" value="{{$data->asal_daerah}}" disabled>
                                        <small class="text-danger asal_daerah_error"></small>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-10">
                                 ...
                                 <a href="/pegawai/pegawai-masuk" type="button" class="btn btn-primary button-update btn-sm"> 
                                    Kembali
                                </a>
