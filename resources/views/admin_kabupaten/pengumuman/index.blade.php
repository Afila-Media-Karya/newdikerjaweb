            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="fv-row mb-10 dropzone-ktp">
                        <div class="drop-zone dropzone-gambar">
                            ...
                            <span class="drop-zone__prompt">Upload Foto Dokumentasi 2Mb</span>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/pengumuman/store', 'Tambah', 'Pengumuman','POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/pengumuman/update/' + uuid, 'Update','Pengumuman', 'POST');
            }
        });

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/pengumuman/show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Pengumuman', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/pengumuman/delete/' + $(this).attr('data-uuid');
            ...
            let columnDefs = [{
                ...
                render: function(data, type, full, meta) {
                    return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="${full.judul}" class="btn btn-danger button-delete btn-icon btn-sm"> 
                                <img src="{{ asset('admin/assets/media/icons/trash.svg')}}" alt="" srcset="">
                            </a>
                            `;
                    },
            }];
            control.initDatatable('/pengumuman/datatable', columns, columnDefs);
        }
