            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="nama_satuan_kerja" class="form-control" name="nama_satuan_kerja" placeholder="Masukkan Nama Satuan Kerja">
                        <small class="text-danger nama_satuan_kerja_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Inisial Satuan Kerja</label>
                        <input type="text" id="inisial_satuan_kerja" class="form-control" name="inisial_satuan_kerja" placeholder="Masukkan Inisial Satuan Kerja">
                        <small class="text-danger inisial_satuan_kerja_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipart('/perangkat-daerah/perangkat-daerah/store', 'Tambah', 'Perangkat Daerah','POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipart('/perangkat-daerah/perangkat-daerah/update/' + uuid, 'Update','Perangkat Daerah', 'POST');
            }
        });

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/perangkat-daerah/perangkat-daerah/show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Perangkat Daerah', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/perangkat-daerah/perangkat-daerah/delete/' + $(this).attr('data-uuid');
        ...
        datatable = () =>{
            ...
            control.initDatatable('/perangkat-daerah/perangkat-daerah/datatable', columns, columnDefs);
        }
