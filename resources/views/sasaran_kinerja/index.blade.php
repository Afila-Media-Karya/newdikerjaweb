                ...
                <form class="form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" name="jenis" type="radio" value="utama"
                                        id="utama" />
                            ...
                            <div class="col-lg-4">
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" name="jenis" type="radio" value="tambahan"
                                        id="tambahan" />
                    ...
                    @if ($level > 2)
                        <div class="mb-10">
                            ...
                            <select class="form-select form-control" name="id_skp_atasan" data-control="select2"
                                data-placeholder="Pilih Sasaran Kerja Atasan Langsung">
                                <option></option>
                            </select>
                    ...
                    @if ($level <= 2)
                        <div id="repeater_iki">
                            <div class="col-md-12 mb-5">
                                <a href="javascript:;" data-repeater-create id="tambah-output-repeater"
                                    class="btn btn-primary btn-block btn-sm" style="width:100%">
                                    <i class="la la-plus"></i>Tambah Indikator
                                </a>
                            </div>
                            <!--begin::Form group-->
                            <div class="form-group">
                                <div data-repeater-list="repeater_iki">
                                    <div data-repeater-item class="repeater-items">
                                        <div class="form-group row">
                                            <div class="row mb-10">
                                                <div class="col-md-10">
                                                    <label class="form-label">Indikator Kerja Individu</label>
                                                    <input type="text" class="form-control iki" name="iki"
                                                        placeholder="Indikator Kerja Individu">
                                                    <small class="text-danger repeater_iki_iki_0_error"></small>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-10">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="text" class="form-control satuan" name="satuan"
                                                        placeholder="Satuan">
                                                    <small class="text-danger repeater_iki_satuan_0_error"></small>
                                                </div>
                                                <div class="col-lg-6">
                                                    <label class="form-label">Target Tahun {{ date('Y') }}</label>
                                                    <input type="number" class="form-control target" name="target"
                                                        placeholder="Satuan">
                                                    <small class="text-danger repeater_iki_target_0_error"></small>
                                                </div>
                                            </div>
                                ...
                                <small class="text-danger repeater_iki_error"></small>
                            </div>
                        </div>
                    @endif
        ...
        function updateErrorClasses(repeaterElement) {
            repeaterElement.find('[class^="form-control"]').each(function(index, element) {
                ...
                if (matches) {
                    ...
                    var extractedValue = lastMatch.substring(1, lastMatch.length -
                    1); // Menghilangkan kurung siku [..]
                    // console.log(indexes); 
                    $(this).siblings('.text-danger').removeClass().addClass('text-danger repeater_iki_' +
                        extractedValue + '_' + indexes + '_error');
                } else {
