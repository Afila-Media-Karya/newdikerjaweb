...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Mutasi');
        })
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/jabatan/mutasi/show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Mutasi', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/jabatan/mutasi/delete/' + $(this).attr('data-uuid');
