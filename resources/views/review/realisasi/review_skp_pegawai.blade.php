                        ...
                        <div class="container">
                            ...
                            <form id="form-skp-review">
                                ...
                                <div class="d-flex justify-content-end gap-5">
                                    ...
                                    <a href="{{route('pegawai.review.sasaran_kinerja.index')}}" class="btn mr-2 btn-light btn-cancel btn-sm d-flex align-items-center" style="background-color: #ea443e65; color: #EA443E"><i class="bi bi-trash-fill" style="color: #EA443E"></i>Batal</a>
                                </div>
...
<script src="https://cdn.jsdelivr.net/gh/ashl1/datatables-rowsgroup@v1.0.0/dataTables.rowsGroup.js"></script>
    ...
    <script>
        ...
        $(document).on('submit', "#form-skp-review", function(e) {
            ...
            $.ajax({
            type: 'POST',
            url: '/review/realisasi-skp/post-review-skp',
            data: $(this).serialize(),
            success: function (response) {
                ...
                swal
                    ...
                    .then(function () {
                        setTimeout(() => {
                            window.location.href = '/review/realisasi-skp';
                        }, 800);
                    });
                } else {
        ...
        datatable = async () =>{
            ...
            let jumlahBarisAsli = $('#kt_table_data tbody tr').length;
            ...
            table.DataTable({
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function(data, type, full, meta) {
                            let checked = full.validation == 1 ? 'checked' : '';
                            let unchecked = full.validation == 0 ? 'checked' : '';
                            let keterangan = '';
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" name="validation[${meta.row}]" ${checked} type="radio" value="1"/>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-check form-check-custom form-check-solid">
                                                <input class="form-check-input" name="validation[${meta.row}]" ${unchecked} type="radio" value="0" />
