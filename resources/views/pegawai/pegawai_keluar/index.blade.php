            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="tujuan_daerah" class="form-control" name="tujuan_daerah" placeholder="Masukkan instansi tujuan">
                        <small class="text-danger tujuan_daerah_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        <label class="form-label">TMT Mutasi Keluar</label>
...
@section('script')
    <script>
        ...
        let url_main = '/pegawai/pegawai-keluar';

        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Pegawai Keluar');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipart(`${url_main}/store`, 'Tambah', 'Pegawai Keluar','POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipart(`${url_main}/update/` + uuid, 'Update','Pegawai Keluar', 'POST');
            }
        });
        ...
        datatable = () =>{
            ...
            let columnDefs = [{
                ...
                render: function(data, type, full, meta) {
                    return `
                            <a href="/pegawai/pegawai-keluar/detail/${full.uuid_pegawai}" type="button" data-uuid="${data}" class="btn btn-warning btn-icon btn-sm"> 
