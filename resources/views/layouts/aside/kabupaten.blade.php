...
@if($role['role'] == '2')
    ...
    <div data-kt-menu-trigger="click" class="menu-item {{ $path[0] == 'pegawai' ? 'show' : '' }} menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'pegawai' && $path[1] == 'list-pegawai' ? 'active' : '' }}"
                    href="{{ route('kabupaten.pegawai.listpegawai.index') }}">
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'pegawai' && $path[1] == 'verifikasi' ? 'active' : '' }}"
                    href="{{ route('kabupaten.pegawai.verifikasi.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'pegawai' && $path[1] == 'pegawai-masuk' ? 'active' : '' }}"
                    href="{{ route('kabupaten.pegawai.pegawaimasuk.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'pegawai' && $path[1] == 'pegawai-keluar' ? 'active' : '' }}"
                    href="{{ route('kabupaten.pegawai.pegawaikeluar.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'pegawai' && $path[1] == 'pegawai-pensiun' ? 'active' : '' }}"
                    href="{{ route('kabupaten.pegawai.pegawaipensiun.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'pegawai' && $path[1] == 'pegawai-akan-pensiun' ? 'active' : '' }}"
                    href="{{ route('kabupaten.pegawai.pegawaiakanpensiun.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'pegawai' && $path[1] == 'pegawai-non-job' ? 'active' : '' }}"
                    href="{{ route('kabupaten.pegawai.pegawainonjob.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div data-kt-menu-trigger="click" class="menu-item {{ $path[0] == 'jabatan' ? 'show' : '' }} menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'jabatan' && $path[1] == 'list-jabatan' ? 'active' : '' }}"
                    href="{{ route('kabupaten.Jabatan.Jabatan.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'jabatan' && $path[1] == 'jabatan-kosong' ? 'active' : '' }}"
                    href="{{ route('kabupaten.Jabatan.jabatan_kosong.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'jabatan' && $path[1] == 'mutasi' ? 'active' : '' }}"
                    href="{{ route('kabupaten.Jabatan.mutasi.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div class="menu-item">
        <a class="menu-link  {{ $path[0] == 'kehadiran' ? 'active' : '' }}" href="{{ route('kabupaten.kehadiran.index') }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                <span class="svg-icon svg-icon-2">
    ...
    <div class="menu-item">
        <a class="menu-link  {{ $path[0] == 'hari-libur' ? 'active' : '' }}"
            ...
            <span class="menu-title" style="{{ $path[0] == 'hari-libur' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">Hari
                Libur</span>
        </a>
    </div>

    <div data-kt-menu-trigger="click"
        class="menu-item {{ in_array($path[0], ['jam-kerja', 'hari-kerja', 'ramadan', 'usia-pensiun', 'tipe-pegawai', 'potongan-kehadiran']) ? 'show' : '' }} menu-accordion">
        <span class="menu-link">
            <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                    <img src="{{ in_array($path[0], ['jam-kerja', 'hari-kerja', 'ramadan', 'usia-pensiun', 'tipe-pegawai', 'potongan-kehadiran']) ? url('admin/assets/media/icons/aside/kehadiranact.svg') : url('/admin/assets/media/icons/aside/kehadirandef.svg') }}"
                        alt="">
                </span>
            </span>
            <span class="menu-title" style="color:#ffffff;">Konfigurasi</span>
            <span class="menu-arrow"></span>
        </span>
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'jam-kerja' ? 'active' : '' }}"
                    href="{{ route('kabupaten.jamkerja.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Pengaturan Absensi</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'hari-kerja' ? 'active' : '' }}"
                    href="{{ route('kabupaten.harikerja.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Hari Kerja</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'ramadan' ? 'active' : '' }}"
                    href="{{ route('kabupaten.ramadan.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Tanggal Ramadan</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'usia-pensiun' ? 'active' : '' }}"
                    href="{{ route('kabupaten.usiapensiun.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Usia Pensiun</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'tipe-pegawai' ? 'active' : '' }}"
                    href="{{ route('kabupaten.tipepegawai.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Tipe Pegawai</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'potongan-kehadiran' ? 'active' : '' }}"
                    href="{{ route('kabupaten.potongankehadiran.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Potongan Kehadiran</span>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="menu-item">
        <a class="menu-link  {{ $path[0] == 'check-aktivitas' ? 'active' : '' }}"
            ...
            <span class="menu-title" style="{{ $path[0] == 'check-aktivitas' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">Check
                Aktivitas</span>
        </a>
    </div>
    ...
    <div class="menu-item">
        <a class="menu-link  {{ $path[0] == 'versi-aplikasi' ? 'active' : '' }}"
            ...
            <span class="menu-title" style="{{ $path[0] == 'versi-aplikasi' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">Versi
                Aplikasi</span>
        </a>
    </div>
...
<div data-kt-menu-trigger="click" class="menu-item {{ $path[0] == 'laporan' ? 'show' : '' }} menu-accordion">
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link {{ $path[0] == 'laporan' && $path[1] == 'sasaran-kinerja' ? 'active' : '' }}"
                href="{{ route('kabupaten.laporan.index') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link {{ $path[0] == 'laporan' && $path[1] == 'kehadiran' ? 'active' : '' }}"
                href="{{ route('kabupaten.laporan.kehadiran.index') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link {{ $path[0] == 'laporan' && $path[1] == 'kinerja' ? 'active' : '' }}"
                href="{{ route('kabupaten.laporan.kinerja.index') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link {{ $path[0] == 'laporan' && $path[1] == 'tpp' ? 'active' : '' }}"
                href="{{ route('kabupaten.laporan.tpp.index') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link {{ $path[0] == 'laporan' && $path[1] == 'profil' ? 'active' : '' }}"
                href="{{ route('kabupaten.laporan.profil.index') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title" style="color:#ffffff;">Pegawai</span>
...
@if($role['role'] == '2')
    ...
    <div data-kt-menu-trigger="click" class="menu-item {{ $path[0] == 'layanan' ? 'show' : '' }} menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'layanan' && $path[1] == 'master-layanan' ? 'active' : '' }}"
                    href="{{ route('kabupaten.layanan.masterlayanan.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'layanan' && $path[1] == 'layanan-cuti' ? 'active' : '' }}"
                    href="{{ route('kabupaten.layanan.layanancuti.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'layanan' && $path[1] == 'layanan-general' ? 'active' : '' }}"
                    href="{{ route('kabupaten.layanan.layanangeneral.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div data-kt-menu-trigger="click" class="menu-item {{ $path[0] == 'master-jabatan' ? 'show' : '' }} menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'master-jabatan' && $path[1] == 'master-jabatan' ? 'active' : '' }}"
                    href="{{ route('kabupaten.master_jabatan.master_jabatan.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Master Jabatan</span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'master-jabatan' && $path[1] == 'kelompok-aktivitas' ? 'active' : '' }}"
                    href="{{ route('kabupaten.master_jabatan.kelompok_aktivitas.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'master-jabatan' && $path[1] == 'jenis-jabatan' ? 'active' : '' }}"
                    href="{{ route('kabupaten.master_jabatan.jenis_jabatan.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div data-kt-menu-trigger="click" class="menu-item {{ $path[0] == 'master-data' ? 'show' : '' }} menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'master-data' && $path[1] == 'satuan' ? 'active' : '' }}"
                    href="{{ route('master_data.satuan.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Satuan</span>
                </a>
                <a class="menu-link {{ $path[0] == 'master-data' && $path[1] == 'pendidikan' ? 'active' : '' }}"
                    href="{{ route('master_data.pendidikan.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Pendidikan</span>
                </a>
                <a class="menu-link {{ $path[0] == 'master-data' && $path[1] == 'agama' ? 'active' : '' }}"
                    href="{{ route('master_data.agama.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Agama</span>
                </a>
                <a class="menu-link {{ $path[0] == 'master-data' && $path[1] == 'golongan' ? 'active' : '' }}"
                    href="{{ route('master_data.golongan.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Golongan</span>
                </a>
                <a class="menu-link {{ $path[0] == 'master-data' && $path[1] == 'eselon' ? 'active' : '' }}"
                    href="{{ route('master_data.eselon.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div data-kt-menu-trigger="click" class="menu-item {{ $path[0] == 'perangkat-daerah' ? 'show' : '' }} menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'perangkat-daerah' && $path[1] == 'perangkat-daerah' ? 'active' : '' }}"
                    href="{{ route('kabupaten.perangkat_daerah.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title" style="color:#ffffff;">Perangkat Daerah</span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'perangkat-daerah' && $path[1] == 'unit-kerja' ? 'active' : '' }}"
                    href="{{ route('kabupaten.unit_kerja.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ $path[0] == 'perangkat-daerah' && $path[1] == 'lokasi' ? 'active' : '' }}"
                    href="{{ route('kabupaten.perangkat_daerah.lokasi.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div class="menu-item">
        <a class="menu-link  {{ $path[0] == 'profil-kepala-daerah' ? 'active' : '' }}"
            ...
            <span class="menu-title"
                style="{{ $path[0] == 'profil-kepala-daerah' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">Profil Kepala
                Daerah</span>
        </a>
    </div>
    ...
    <div class="menu-item">
        <a class="menu-link  {{ $path[0] == 'user' ? 'active' : '' }}" href="{{ route('kabupaten.pegawai.user.index') }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                <span class="svg-icon svg-icon-2">
            ...
            <span class="menu-title" style="{{ $path[0] == 'user' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">User</span>
        </a>
    </div>
    ...
    <div class="menu-item">
        <a class="menu-link  {{ $path[0] == 'admin' ? 'active' : '' }}" href="{{ route('kabupaten.admin.index') }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                <span class="svg-icon svg-icon-2">
            ...
            <span class="menu-title" style="{{ $path[0] == 'admin' ? 'color: #F4BE2A' : 'color: #FFFFFF' }}">Admin</span>
        </a>
    </div>
