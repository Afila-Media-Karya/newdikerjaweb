                            ...
                            <div class="py-5">
                                ...
                                <div class="row mb-10">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm" value="{{ $data->jabatan_lama }} - {{$data->satuan_kerja_lama}}" disabled>
                                        <small class="text-danger asal_daerah_error"></small>
                                    </div>

                                    <div class="col-lg-6">
                                        <label class="form-label">Jabatan Baru</label>
                                        <input type="text" class="form-control form-control-sm" value="{{ $data->jabatan_baru }} - {{$data->satuan_kerja_baru}}" disabled>
                                        <small class="text-danger asal_daerah_error"></small>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    <div class="col-lg-6">
                                        <label class="form-label">TMT Mutasi</label>
                                        <input type="text" class="form-control form-control-sm" value="{{ \Carbon\Carbon::parse($data->tmt_mutasi)->format('j F Y') }}" disabled>
                                        <small class="text-danger asal_daerah_error"></small>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-10">
                                 ...
                                 <a href="/jabatan/mutasi" type="button" class="btn btn-primary button-update btn-sm"> 
                                    Kembali
                                </a>
