    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a href="#" id="export-struktur" data-type="pdf" class="btn btn-sm btn-dark">
                <img src="{{asset('admin/assets/media/icons/pdf.svg')}}" style="position: relative; bottom: 1px;" alt=""
                    srcset="">
                Cetak Struktur
            </a>
        </div>
                            ...
                            <div class="py-5">
                                ...
                                <div style="position:absolute">
                                    <div class="btn-group" style="position: relative;left: 26rem;top: 12px;width:38rem;">
                                        <select name="tenaga_kesehatan_id" id="satuan_kerja_filter" data-control="select2"
                                            data-placeholder="Filter Satuan Kerja"
            ...
            <div class="card-header pe-5">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex justify-content-center flex-column me-3">
                        <a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 lh-1 title_side_form">Update
                            Jabatan</a>
                    </div>
                    <!--end::User-->
                </div>
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10" style="display:none">
                        ...
                        <select class="form-select form-control" id="id_satuan_kerja" name="id_satuan_kerja"
                            ...
                            @foreach($satuan_kerja as $val)
                                <option value="{{$val->value}}" @if($val->value == $satuan_kerja_user) selected @endif>
                                    {{$val->text}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-10" id="pagu_tpp_konten">
                        ...
                        <input type="text" id="pagu_tpp" class="form-control pagu_tpp" value="0" name="pagu_tpp"
                            data-inputmask="'alias': 'currency', 'radixPoint': ',', 'groupSeparator': '.', 'numericInput': true, 'autoUnmask': true, 'rightAlign': false">
                        <small class="text-danger pagu_tpp_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Target Waktu</label>
                        <input type="number" id="target_waktu" class="form-control" name="target_waktu"
                            placeholder="Masukkan Targer Waktu">
...
@section('script')
    <script>
        ...
        $(document).on('click', '.button-update', function (e) {
            ...
            $('#id_satuan_kerja, #id_unit_kerja,#id_lokasi_kerja,#id_lokasi_apel,#id_master_jabatan, .form-check-input[name="status"], #pagu_tpp, #target_waktu, select[name="pembayaran"], #id_parent').prop('disabled', true);
