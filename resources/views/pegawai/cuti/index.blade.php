        ...
        <div class="card w-100">
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div id="keterangan-perubahan" style="display:none">
                        <span class="badge badge-warning">Keterangan Perubahan</span>
                        <p class="fw-bolder"></p>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <textarea id="alamat" class="form-control" name="alamat" rows="3" placeholder="Masukkan alamat selama cuti"></textarea>
                        <small class="text-danger alamat_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Alasan</label>
                        <textarea id="alasan" class="form-control" name="alasan" rows="3" placeholder="Masukkan alasan"></textarea>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/layanan-pegawai/layanan-cuti/store', 'Tambah', 'Layanan Cuti','POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/layanan-pegawai/layanan-cuti/update/' + uuid, 'Update','Layanan Cuti', 'POST');
            }
        });

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/layanan-pegawai/layanan-cuti/show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Layanan Cuti', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/layanan-pegawai/layanan-cuti/delete/' + $(this).attr('data-uuid');
            ...
            let columnDefs = [{
                ...
                render: function(data, type, full, meta) {
                    ...
                    return `
                            ...
                            <a href="/layanan-pegawai/layanan-cuti/detail/${data}" type="button" data-uuid="${data}" class="btn btn-warning btn-icon btn-sm"> 
                                <img src="{{ asset('admin/assets/media/icons/eye.svg')}}" alt="" srcset="">
                            </a>
                            `;
                    },
            }];
            control.initDatatable('/layanan-pegawai/layanan-cuti/datatable', columns, columnDefs);
        }
