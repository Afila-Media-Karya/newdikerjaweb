<div id="side_form_riwayat_kepangkatan" class="bg-white" data-kt-drawer="true" data-kt-drawer-activate="true"
        data-kt-drawer-toggle="#side_form_riwayat_kepangkatan_button" data-kt-drawer-close="#side_form_riwayat_kepangkatan_close" data-kt-drawer-width="500px">
        <!--begin::Card-->
        <div class="card w-100">
            ...
            <div class="card-header pe-5">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex justify-content-center flex-column me-3">
                        <a href="#"
                            class="fs-4 fw-bolder text-gray-900 title_side_form text-hover-primary me-1 lh-1 title_side_form_riwayat_kepangkatan"></a>
                    </div>
                    <!--end::User-->
                </div>
                <!--end::Title-->
                ...
                <div class="card-toolbar">
                    <!--begin::Close-->
                    <div class="btn btn-sm btn-icon btn-active-light-primary" id="side_form_riwayat_kepangkatan_close">
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" id="riwayat-kepangkatan">
                   ...
                   <div class="mb-10">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="number" id="gaji_pokok" class="form-control"  name="gaji_pokok" placeholder="Masukkan gaji_pokok">
                        <small class="text-danger gaji_pokok_error"></small>
                    </div>
                   ...
                   <div class="mb-10">
                    ...
                    <div class="d-flex gap-5">
                        ...
                        <button type="reset" id="side_form_riwayat_kepangkatan_close"
