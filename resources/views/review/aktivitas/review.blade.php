                ...
                <form class="form-data">
                    ...
                    <div class="row mb-10">
                        <div class="col-lg-4">
                            ...
                            <input type="number" id="hasil" class="form-control" name="volume", placeholder="Hasil" readonly>
                  ...
                  columns: [
                    ...
                    },
                    {
                      ...
                      render: function (data, type, row, meta) {
                        ...
                        let bulan = tanggalObjek.toLocaleString("default", {
                          month: "long",
                        });
                    ...
                    },
                    {
                      ...
                      className: "text-center",
                        render: function (data, type, row, meta) {
                            ...
                            // regex untuk deteksi URL (global, bisa banyak link)
                            const urlPattern = /(https?:\/\/[^\s]+)/g;

                            // replace semua URL jadi anchor
                            let result = data.replace(urlPattern, function (url) {
                    ...
                    if (lastData) {
                      ...
                      if (lastData.target_waktu > 0) {
                        nilai_produktivitas_kerja =
                          (capaian_prod_kinerja / lastData.target_waktu) * 100;
                      }
                      ...
                      cellsThirdRow
                        ...
                        .addClass("text-center")
                        .html(
                          `<span class="badge badge-primary">${nilai_produktivitas_kerja.toFixed(
                            2
                          )}</span>`
                        );
                    }
